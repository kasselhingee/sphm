...
or for the lower concentration situaton
...
The return `y_ld` was a matrix of 42 rows and 6 columns, with the final column being the log-density of the simulated response. Our Mobius-link regression with scaled von Mises-Fisher error distribution was then fitted to the simulation by
