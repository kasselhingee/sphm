...
mnlink_Omega_cpp<double> R2OmegaS2S_double(Rcpp::List obj) {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 1> c1 = Rcpp::as<Eigen::Matrix<double, Eigen::Dynamic, 1>>(obj["c1"]);
    Eigen::Matrix<double, Eigen::Dynamic, 1> PBc = Rcpp::as<Eigen::Matrix<double, Eigen::Dynamic, 1>>(obj["PBc"]);
    return mnlink_Omega_cpp<double>(p1, qs1, qe1, Omega, c1, PBc);
}
...
mnlink_Omega_cpp<a1type> R2OmegaS2S_a1type(Rcpp::List obj) {
    ...
    veca1 c1 = Rcpp::as<veca1>(obj["c1"]);
    veca1 PBc = Rcpp::as<veca1>(obj["PBc"]);
    return mnlink_Omega_cpp<a1type>(p1, qs1, qe1, Omega, c1, PBc);
}
