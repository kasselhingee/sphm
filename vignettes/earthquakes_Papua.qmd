...
Depth = 3 is accounted for fairly well.
...
## Conclusion
This model is not okay.
There are a few outliers in the standardised residuals and standardised residual size increases with longitude.
