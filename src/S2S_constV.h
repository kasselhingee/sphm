...
pADFun tape_ull_S2S_constV_axes(veca1 & vecCayaxes, mnlink_Omega_cpp<a1type> om, a1type k, a1type a1, veca1 aremaining, vecd & p_in, matd & yx);

// tape for aremaining. Like _mean but everything else constant
pADFun tape_ull_S2S_constV_aremaining(veca1 & aremaining, mnlink_Omega_cpp<a1type> om, a1type k, a1type a1, mata1 Gstar, vecd & p_in, matd & yx);


// tape for k
pADFun tape_ull_S2S_constV_k(veca1 k, mnlink_Omega_cpp<a1type> om, a1type a1, veca1 & aremaining, mata1 Gstar, vecd & p_in, matd & yx);
