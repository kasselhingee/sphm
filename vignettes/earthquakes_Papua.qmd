...
# Look for Outliers
Here I'll look for obvious outliers using Longitude and fstrike.
...
+ Some outliers in standard residuals, but could be consistent with Gaussian.
+ `srdist` increases with `fstrike` (bad)

This model is maybe bad.
...
+ There are a few outliers in the standardised residuals
...
+ Some instability in estimation.
+ Reaches parallel transport singularity
+ There are a few outliers in the standardised residuals
