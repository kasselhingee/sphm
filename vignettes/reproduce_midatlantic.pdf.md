...
than $0.1$: by the evaluation limit the likelihood has effectively settled, and what is
still drifting is the direction of `G0`, which is unidentifiable as the scales `a`
approach 1.
