...
#' Starting points are generated by \code{\link{signflip_starts}}: sign-flips of p1, qs1, qe1,
#' plus an alternative \code{ce} value from the opposite size regime when xe is present.
...
mobius_SvMF_multistart <- function(y, xs = NULL, xe = NULL,
  ...
  mod1 <- mobius_SvMF_signflip_refit(mod0,
                                      type = type, fix_qs1 = fix_qs1, fix_qe1 = fix_qe1,
                                      intercept = intercept, G01behaviour = G01behaviour,
                                      xtol_rel = xtol_rel, maxeval = maxeval, ...)
