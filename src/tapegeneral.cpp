...
//' mata1 fun(const veca1 & independent, const veca2 & dynamic, const vecd & constvec, const matd & constmat).
...
CppAD::ADFun<double> tapefun(mata1 (*fun)(const veca1 &, const veca1 &, const matd &), veca1 & ind_t, veca1 & dyn_t, const vecd & constvec, matd & constmat) {
