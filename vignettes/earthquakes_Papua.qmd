...
Depth = 3 could be incorporated better.
...
+ Axes for L < 148 tend to focus towards a point
+ Standardised residuals have one outlier.
+ Depth = 3 could be incorporated better.
...
+ Axes for L < 148 tend to focus towards a point
+ Standardised residuals have three outliers.
+ Accounts for Depth = 3.
