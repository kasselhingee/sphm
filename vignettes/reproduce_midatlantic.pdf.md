...
The discarded fits have systematically *smaller* likelihood ratios than the retained ones, so discarding them makes the test conservative rather than optimistic.
