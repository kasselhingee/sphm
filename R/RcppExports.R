...
ll_SvMF_S2S_alignedG_mean <- function(vec, dyn, p_in, yx) {
...
ll_SvMF_S2S_alignedG_k <- function(k, dyn, p_in, yx) {
    .Call('_sphm_ll_SvMF_S2S_alignedG_k', PACKAGE = 'sphm', k, dyn, p_in, yx)
}
